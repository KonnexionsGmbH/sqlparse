...
> gen_tests_and_run.log (
    ...
    ECHO !DATE!_!TIME! Start Test Data Generation and Run
    ...
    ECHO !DATE!_!TIME! Start EUnit Tests
    SET SOURCEFILES_OLD=SOURCEFILES
    SET SOURCEFILES=
    CALL rebar3 eunit

    SET SOURCEFILES=SOURCEFILES_OLD
    ECHO !DATE!_!TIME! Start Common Tests
    CALL rebar3 ct

    ECHO !DATE!_!TIME! Start Coverage Analysis
    CALL rebar3 cover

    ECHO !DATE!_!TIME! Start Dialyzer
    CALL rebar3 dialyzer

    ECHO !DATE!_!TIME! End   Test Data Generation and Run

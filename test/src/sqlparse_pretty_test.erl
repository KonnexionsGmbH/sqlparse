...
default_PROBLEM_01_test() ->
    ?D("Start ~n"),
    ?assertEqual({ok, list_to_binary(?PROBLEM_01_RESULT_DEFAULT)},
        sqlparse_test_utils:eunit_test(?PROBLEM_01,
            [{case_identifier, init_cap}])).

default_PROBLEM_02_test() ->
    ?D("Start ~n"),
    ?assertEqual({ok, list_to_binary(?PROBLEM_02_RESULT_DEFAULT)},
        sqlparse_test_utils:eunit_test(?PROBLEM_02,
            [{case_identifier, init_cap}])).

default_PROBLEM_03_test() ->
    ?D("Start ~n"),
    ?assertEqual({ok, list_to_binary(?PROBLEM_03_RESULT_DEFAULT)},
        sqlparse_test_utils:eunit_test(?PROBLEM_03,
            [{case_identifier, init_cap}])).

default_PROBLEM_04_test() ->
    ?D("Start ~n"),
    ?assertEqual({ok, list_to_binary(?PROBLEM_04_RESULT_DEFAULT)},
        sqlparse_test_utils:eunit_test(?PROBLEM_04,
            [{case_identifier, init_cap}])).

default_PROBLEM_05_test() ->
    ?D("Start ~n"),
    ?assertEqual({ok, list_to_binary(?PROBLEM_05_RESULT_DEFAULT)},
        sqlparse_test_utils:eunit_test(?PROBLEM_05,
            [{case_identifier, init_cap}])).

default_PROBLEM_06_test() ->
    ?D("Start ~n"),
    ?assertEqual({ok, list_to_binary(?PROBLEM_06_RESULT_DEFAULT)},
        sqlparse_test_utils:eunit_test(?PROBLEM_06,
            [{case_identifier, init_cap}])).
...
default_CREATE_test_() ->
    ...
    LOpts = [{case_identifier, init_cap}],
    {
        ...
        fun() ->
            [
                {formatter("CREATE_01", ?CREATE_01,
                    ?CREATE_01_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_02", ?CREATE_02,
                    ?CREATE_02_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_03", ?CREATE_03,
                    ?CREATE_03_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_04", ?CREATE_04,
                    ?CREATE_04_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_05", ?CREATE_05,
                    ?CREATE_05_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_06", ?CREATE_06,
                    ?CREATE_06_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_07", ?CREATE_07,
                    ?CREATE_07_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_08", ?CREATE_08,
                    ?CREATE_08_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_09", ?CREATE_09,
                    ?CREATE_09_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_10", ?CREATE_10,
                    ?CREATE_10_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_11", ?CREATE_11,
                    ?CREATE_11_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_12", ?CREATE_12,
                    ?CREATE_12_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_13", ?CREATE_13,
                    ?CREATE_13_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_14", ?CREATE_14,
                    ?CREATE_14_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_15", ?CREATE_15,
                    ?CREATE_15_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_16", ?CREATE_16,
                    ?CREATE_16_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_17", ?CREATE_17,
                    ?CREATE_17_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_18", ?CREATE_18,
                    ?CREATE_18_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_19", ?CREATE_19,
                    ?CREATE_19_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_20", ?CREATE_20,
                    ?CREATE_20_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_21", ?CREATE_21,
                    ?CREATE_21_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_22", ?CREATE_22,
                    ?CREATE_22_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_23", ?CREATE_23,
                ...
                {formatter("CREATE_25", ?CREATE_25,
                    ...
                    LOpts)},
                {formatter("CREATE_26", ?CREATE_26,
                    ?CREATE_26_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_27", ?CREATE_27,
                    ?CREATE_27_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_28", ?CREATE_28,
                    ?CREATE_28_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_29", ?CREATE_29,
                    ?CREATE_29_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_30", ?CREATE_30,
                    ?CREATE_30_RESULT_DEFAULT,
                    LOpts)},
                {formatter("CREATE_31", ?CREATE_31,
...
default_DELETE_test_() ->
    ...
    LOpts = [{case_identifier, init_cap}],
    {
        ...
        fun() ->
            [
                {formatter("DELETE_01", ?DELETE_01,
                    ?DELETE_01_RESULT_DEFAULT,
                    LOpts)},
                {formatter("DELETE_03", ?DELETE_03,
                    ?DELETE_03_RESULT_DEFAULT,
                    LOpts)},
                {formatter("DELETE_04", ?DELETE_04,
                    ?DELETE_04_RESULT_DEFAULT,
                    LOpts)},
                {formatter("DELETE_05", ?DELETE_05,
                    ?DELETE_05_RESULT_DEFAULT,
                    LOpts)},
                {formatter("DELETE_06", ?DELETE_06,
                    ?DELETE_06_RESULT_DEFAULT,
                    LOpts)},
                {formatter("DELETE_07", ?DELETE_07,
        ...
        fun() ->
            [
                {formatter("GROUP_BY_01", ?GROUP_BY_01,
                    ?GROUP_BY_01_RESULT_DEFAULT, LOpts)},
                {formatter("GROUP_BY_02", ?GROUP_BY_02,
                    ?GROUP_BY_02_RESULT_DEFAULT, LOpts)},
                {formatter("GROUP_BY_03", ?GROUP_BY_03,
                    ?GROUP_BY_03_RESULT_DEFAULT, LOpts)},
                {formatter("GROUP_BY_04", ?GROUP_BY_04,
                    ?GROUP_BY_04_RESULT_DEFAULT, LOpts)},
                {formatter("GROUP_BY_05", ?GROUP_BY_05,
                    ?GROUP_BY_05_RESULT_DEFAULT, LOpts)},
                {formatter("GROUP_BY_06", ?GROUP_BY_06,
                    ?GROUP_BY_06_RESULT_DEFAULT, LOpts)},
                {formatter("GROUP_BY_07", ?GROUP_BY_07,
                    ?GROUP_BY_07_RESULT_DEFAULT, LOpts)},
                {formatter("GROUP_BY_08", ?GROUP_BY_08,
                    ?GROUP_BY_08_RESULT_DEFAULT, LOpts)},
                {formatter("GROUP_BY_09", ?GROUP_BY_09,
                    ?GROUP_BY_09_RESULT_DEFAULT, LOpts)}
            ]
        end
    }.
...
default_HAVING_test_() ->
    ...
    LOpts = [{case_identifier, init_cap}],
    {
        ...
        fun() ->
            [
                {formatter("HAVING_01", ?HAVING_01,
                    ?HAVING_01_RESULT_DEFAULT,
                    LOpts)},
                {formatter("HAVING_02", ?HAVING_02,
...
default_INSERT_test_() ->
    ...
    LOpts = [{case_identifier, init_cap}],
    {
        ...
        fun() ->
            [
                {formatter("INSERT_01", ?INSERT_01,
                    ?INSERT_01_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_02", ?INSERT_02,
                    ?INSERT_02_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_03", ?INSERT_03,
                    ?INSERT_03_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_04", ?INSERT_04,
                    ?INSERT_04_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_05", ?INSERT_05,
                    ?INSERT_05_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_06", ?INSERT_06,
                    ?INSERT_06_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_07", ?INSERT_07,
                    ?INSERT_07_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_08", ?INSERT_08,
                    ?INSERT_08_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_09", ?INSERT_09,
                    ?INSERT_09_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_10", ?INSERT_10,
                    ?INSERT_10_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_11", ?INSERT_11,
                    ?INSERT_11_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_12", ?INSERT_12,
                    ?INSERT_12_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_13", ?INSERT_13,
                    ?INSERT_13_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_14", ?INSERT_14,
                    ?INSERT_14_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_15", ?INSERT_15,
                    ?INSERT_15_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_16", ?INSERT_16,
                    ?INSERT_16_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_17", ?INSERT_17,
                    ?INSERT_17_RESULT_DEFAULT,
                    LOpts)},
                {formatter("INSERT_18", ?INSERT_18,
                    ?INSERT_18_RESULT_DEFAULT,
                    LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("MISCELLANEOUS_02", ?MISCELLANEOUS_02,
                    ?MISCELLANEOUS_02_RESULT_DEFAULT, LOpts)},
                {formatter("MISCELLANEOUS_03", ?MISCELLANEOUS_03,
                    ?MISCELLANEOUS_03_RESULT_DEFAULT, LOpts)},
                {formatter("MISCELLANEOUS_04", ?MISCELLANEOUS_04,
                    ?MISCELLANEOUS_04_RESULT_DEFAULT, LOpts)},
                {formatter("MISCELLANEOUS_05", ?MISCELLANEOUS_05,
                    ?MISCELLANEOUS_05_RESULT_DEFAULT, LOpts)},
                {formatter("MISCELLANEOUS_06", ?MISCELLANEOUS_06,
                    ?MISCELLANEOUS_06_RESULT_DEFAULT, LOpts)},
                {formatter("MISCELLANEOUS_07", ?MISCELLANEOUS_07,
                    ?MISCELLANEOUS_07_RESULT_DEFAULT, LOpts)},
                {formatter("MISCELLANEOUS_08", ?MISCELLANEOUS_08,
                    ?MISCELLANEOUS_08_RESULT_DEFAULT, LOpts)},
        ...
        fun() ->
            [
                {formatter("MULTIPLE_01", ?MULTIPLE_01,
                    ?MULTIPLE_01_RESULT_DEFAULT, LOpts)},
                {formatter("MULTIPLE_02", ?MULTIPLE_02,
                    ?MULTIPLE_02_RESULT_DEFAULT, LOpts)},
                {formatter("MULTIPLE_03", ?MULTIPLE_03,
                    ?MULTIPLE_03_RESULT_DEFAULT, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("ORDER_BY_01", ?ORDER_BY_01,
                    ?ORDER_BY_01_RESULT_DEFAULT, LOpts)},
                {formatter("ORDER_BY_02", ?ORDER_BY_02,
                    ?ORDER_BY_02_RESULT_DEFAULT, LOpts)},
                {formatter("ORDER_BY_03", ?ORDER_BY_03,
                    ?ORDER_BY_03_RESULT_DEFAULT, LOpts)}
            ]
        end
    }.
...
default_PARENTHESES_test_() ->
    ...
    LOpts = [{case_identifier, init_cap}],
    {
        ...
        fun() ->
            [
                {formatter("PARENTHESES_01", ?PARENTHESES_01,
                    ?PARENTHESES_01_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_02", ?PARENTHESES_02,
                    ?PARENTHESES_02_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_03", ?PARENTHESES_03,
                    ?PARENTHESES_03_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_04", ?PARENTHESES_04,
                    ?PARENTHESES_04_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_05", ?PARENTHESES_05,
                    ?PARENTHESES_05_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_06", ?PARENTHESES_06,
                    ?PARENTHESES_06_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_07", ?PARENTHESES_07,
                    ?PARENTHESES_07_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_11", ?PARENTHESES_11,
                    ?PARENTHESES_11_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_12", ?PARENTHESES_12,
                    ?PARENTHESES_12_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_13", ?PARENTHESES_13,
                    ?PARENTHESES_13_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_14", ?PARENTHESES_14,
                    ?PARENTHESES_14_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_21", ?PARENTHESES_21,
                    ?PARENTHESES_21_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_22", ?PARENTHESES_22,
                    ?PARENTHESES_22_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_23", ?PARENTHESES_23,
                    ?PARENTHESES_23_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_24", ?PARENTHESES_24,
                    ?PARENTHESES_24_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_25", ?PARENTHESES_25,
                    ?PARENTHESES_25_RESULT_DEFAULT, LOpts)},
                {formatter("PARENTHESES_26", ?PARENTHESES_26,
                    ?PARENTHESES_26_RESULT_DEFAULT, LOpts)},
        ...
        fun() ->
            [
                ...
                {formatter("PLSQL_26", ?PLSQL_26, ?PLSQL_26_RESULT_DEFAULT,
                    LOpts)},
                {formatter("PLSQL_27", ?PLSQL_27, ?PLSQL_27_RESULT_DEFAULT,
                    LOpts)},
                {formatter("PLSQL_28", ?PLSQL_28, ?PLSQL_28_RESULT_DEFAULT,
                    LOpts)},
                {formatter("PLSQL_29", ?PLSQL_29, ?PLSQL_29_RESULT_DEFAULT,
                    LOpts)}
            ]
        end
    }.
...
default_REVOKE_test_() ->
    ...
    LOpts = [{case_identifier, init_cap}],
    {
        ...
        fun() ->
            [
                {formatter("REVOKE_01", ?REVOKE_01,
                    ?REVOKE_01_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_02", ?REVOKE_02,
                    ?REVOKE_02_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_03", ?REVOKE_03,
                    ?REVOKE_03_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_04", ?REVOKE_04,
                    ?REVOKE_04_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_05", ?REVOKE_05,
                    ?REVOKE_05_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_06", ?REVOKE_06,
                    ?REVOKE_06_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_07", ?REVOKE_07,
                    ?REVOKE_07_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_08", ?REVOKE_08,
                    ?REVOKE_08_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_09", ?REVOKE_09,
                    ?REVOKE_09_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_10", ?REVOKE_10,
                    ?REVOKE_10_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_11", ?REVOKE_11,
                    ?REVOKE_11_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_12", ?REVOKE_12,
                    ?REVOKE_12_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_13", ?REVOKE_13,
                    ?REVOKE_13_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_14", ?REVOKE_14,
                    ?REVOKE_14_RESULT_DEFAULT,
                    LOpts)},
                {formatter("REVOKE_15", ?REVOKE_15,
...
default_SELECT_test_() ->
    ...
    LOpts = [{case_identifier, init_cap}],
    {
        ...
        fun() ->
            [
                {formatter("SELECT_01", ?SELECT_01,
                    ?SELECT_01_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_02", ?SELECT_02,
                    ?SELECT_02_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_03", ?SELECT_03,
                    ?SELECT_03_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_04", ?SELECT_04,
                    ?SELECT_04_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_05", ?SELECT_05,
                    ?SELECT_05_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_06", ?SELECT_06,
                    ?SELECT_06_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_07", ?SELECT_07,
                    ?SELECT_07_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_08", ?SELECT_08,
                    ?SELECT_08_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_09", ?SELECT_09,
                    ?SELECT_09_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_10", ?SELECT_10,
                    ?SELECT_10_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_11", ?SELECT_11,
                    ?SELECT_11_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_12", ?SELECT_12,
                    ?SELECT_12_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_13", ?SELECT_13,
                    ?SELECT_13_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_14", ?SELECT_14,
                    ?SELECT_14_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_15", ?SELECT_15,
                    ?SELECT_15_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_16", ?SELECT_16,
                    ?SELECT_16_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_17", ?SELECT_17,
                    ?SELECT_17_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_18", ?SELECT_18,
                    ?SELECT_18_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_19", ?SELECT_19,
                    ?SELECT_19_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_20", ?SELECT_20,
                    ?SELECT_20_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_21", ?SELECT_21,
                    ?SELECT_21_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_22", ?SELECT_22,
                    ?SELECT_22_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_23", ?SELECT_23,
                    ?SELECT_23_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_24", ?SELECT_24,
                    ?SELECT_24_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_25", ?SELECT_25,
                    ?SELECT_25_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_26", ?SELECT_26,
                    ?SELECT_26_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_27", ?SELECT_27,
                    ?SELECT_27_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_28", ?SELECT_28,
                    ?SELECT_28_RESULT_DEFAULT,
                    LOpts)},
                {formatter("SELECT_29", ?SELECT_29,
        ...
        fun() ->
            [
                {formatter("STRUCTURE_01", ?STRUCTURE_01,
                    ?STRUCTURE_01_RESULT_DEFAULT, LOpts)},
                {formatter("STRUCTURE_02", ?STRUCTURE_02,
                    ?STRUCTURE_02_RESULT_DEFAULT, LOpts)},
                {formatter("STRUCTURE_03", ?STRUCTURE_03,
                    ?STRUCTURE_03_RESULT_DEFAULT, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("TRANSACTION_01", ?TRANSACTION_01,
                    ?TRANSACTION_01_RESULT_DEFAULT, LOpts)},
                {formatter("TRANSACTION_02", ?TRANSACTION_02,
                    ?TRANSACTION_02_RESULT_DEFAULT, LOpts)},
                {formatter("TRANSACTION_03", ?TRANSACTION_03,
                    ?TRANSACTION_03_RESULT_DEFAULT, LOpts)},
                {formatter("TRANSACTION_04", ?TRANSACTION_04,
                    ?TRANSACTION_04_RESULT_DEFAULT, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("TRUNCATE_01", ?TRUNCATE_01,
                    ?TRUNCATE_01_RESULT_DEFAULT, LOpts)},
                {formatter("TRUNCATE_02", ?TRUNCATE_02,
                    ?TRUNCATE_02_RESULT_DEFAULT, LOpts)},
                {formatter("TRUNCATE_03", ?TRUNCATE_03,
                    ?TRUNCATE_03_RESULT_DEFAULT, LOpts)},
                {formatter("TRUNCATE_04", ?TRUNCATE_04,
                    ?TRUNCATE_04_RESULT_DEFAULT, LOpts)},
                {formatter("TRUNCATE_05", ?TRUNCATE_05,
                    ?TRUNCATE_05_RESULT_DEFAULT, LOpts)},
                {formatter("TRUNCATE_06", ?TRUNCATE_06,
                    ?TRUNCATE_06_RESULT_DEFAULT, LOpts)},
                {formatter("TRUNCATE_07", ?TRUNCATE_07,
                    ?TRUNCATE_07_RESULT_DEFAULT, LOpts)}
            ]
        end
    }.
...
default_UNBREAKABLE_test_() ->
    ...
    LOpts = [{case_identifier, init_cap}],
    {
        ...
        fun() ->
            [
                {formatter("UNBREAKABLE_01", ?UNBREAKABLE_01,
                    ?UNBREAKABLE_01_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_02", ?UNBREAKABLE_02,
                    ?UNBREAKABLE_02_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_03", ?UNBREAKABLE_03,
                    ?UNBREAKABLE_03_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_04", ?UNBREAKABLE_04,
                    ?UNBREAKABLE_04_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_05", ?UNBREAKABLE_05,
                    ?UNBREAKABLE_05_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_06", ?UNBREAKABLE_06,
                    ?UNBREAKABLE_06_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_07", ?UNBREAKABLE_07,
                    ?UNBREAKABLE_07_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_08", ?UNBREAKABLE_08,
                    ?UNBREAKABLE_08_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_09", ?UNBREAKABLE_09,
                    ?UNBREAKABLE_09_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_10", ?UNBREAKABLE_10,
                    ?UNBREAKABLE_10_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_11", ?UNBREAKABLE_11,
                    ?UNBREAKABLE_11_RESULT_DEFAULT, LOpts)},
                {formatter("UNBREAKABLE_12", ?UNBREAKABLE_12,
                    ?UNBREAKABLE_12_RESULT_DEFAULT, LOpts)}
            ]
        end
    }.
...
default_UPDATE_test_() ->
    ...
    LOpts = [{case_identifier, init_cap}],
    {
        ...
        fun() ->
            [
                {formatter("UPDATE_01", ?UPDATE_01,
                    ?UPDATE_01_RESULT_DEFAULT,
                    LOpts)},
                {formatter("UPDATE_02", ?UPDATE_02,
                    ?UPDATE_02_RESULT_DEFAULT,
                    LOpts)},
                {formatter("UPDATE_03", ?UPDATE_03,
                    ?UPDATE_03_RESULT_DEFAULT,
                    LOpts)},
                {formatter("UPDATE_04", ?UPDATE_04,
                    ?UPDATE_04_RESULT_DEFAULT,
                    LOpts)},
                {formatter("UPDATE_05", ?UPDATE_05,
                    ?UPDATE_05_RESULT_DEFAULT,
                    LOpts)},
                {formatter("UPDATE_06", ?UPDATE_06,
                    ?UPDATE_06_RESULT_DEFAULT,
                    LOpts)},
                {formatter("UPDATE_07", ?UPDATE_07,
        ...
        fun() ->
            [
                {formatter("OPTION_01_K_I_4_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_K_I_4_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_K_L_4_S_F", ?OPTION_01,
                    ?OPTION_01_RESULT_K_L_4_S_F, LOpts)},
                {formatter("OPTION_02_K_L_4_S_F", ?OPTION_02,
                    ?OPTION_02_RESULT_K_L_4_S_F, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_L_U_4_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_L_U_4_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_U_L_1_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_U_L_1_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_U_L_2_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_U_L_2_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_U_L_3_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_U_L_3_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_U_L_4_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_U_L_4_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_U_L_5_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_U_L_5_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_U_L_6_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_U_L_6_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_U_L_7_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_U_L_7_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_U_L_8_S_T", ?OPTION_01,
                    ?OPTION_01_RESULT_U_L_8_S_T, LOpts)}
            ]
        end
    }.
        ...
        fun() ->
            [
                {formatter("OPTION_01_U_L___T_T", ?OPTION_01,
                    ?OPTION_01_RESULT_U_L___T_T, LOpts)}
            ]
        end
    }.
...
parameter_invalid_test() ->
    ?D("Start ~n"),
    ?assertThrow(invalid_parameter_value,
        sqlparse_test_utils:eunit_test("select * from dual",
            [{case_identifier, wwe}])),
    ?assertThrow(invalid_parameter_value,
        sqlparse_test_utils:eunit_test("select * from dual",
            [{case_keyword, wwe}])),
    ...
    ?assertThrow(invalid_parameter_value,
        sqlparse_test_utils:eunit_test("select * from dual",
            [{line_break_after, wwe}])),
    ?assertThrow(invalid_parameter_value,
        sqlparse_test_utils:eunit_test("select * from dual",
            [{ws_operator, wwe}])),
    ?assertThrow(invalid_parameter,
        sqlparse_test_utils:eunit_test("select * from dual",
            [{wwe, wwe}])).

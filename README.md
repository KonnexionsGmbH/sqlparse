...
[![Build Status](https://travis-ci.org/walter-weinmann/sqlparse.svg?branch=master)](https://travis-ci.org/walter-weinmann/sqlparse) [![Coverage Status](https://coveralls.io/repos/github/walter-weinmann/sqlparse/badge.svg?branch=wwe_3.1.0_travis)](https://coveralls.io/github/walter-weinmann/sqlparse?branch=wwe_3.1.0_travis)
